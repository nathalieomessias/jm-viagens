...
"resource": {
  ...
  "rules":[
    ...
    [["if",5,6],["add",2,9,10,13,15,16,20,23,29,34,36,48,49,56,57]],
    [["if",3,7],["add",3,4]],
    [["if",3,4],["add",5],["block",1,7,30,0,35,42,45,50,54]],
    [["if",3],["add",5,35,50,53,24,25,27,28]],
    [["if",3,9],["unless",8],["add",6,14,38]],
    [["if",10,11],["add",7]],
    [["if",12,13,14],["add",8]],
    [["if",3,15],["add",11,40]],
    [["if",14,16,17],["add",12,41]],
    [["if",3,18],["add",14,38]],
    [["if",3,19],["add",14]],
    [["if",3,20],["add",14,38],["block",42]],
    [["if",3,18,21],["add",14,38]],
    [["if",3,22],["add",14,38]],
    [["if",3,23],["add",14,38]],
    [["if",3,24],["add",14,38]],
    [["if",3,25],["add",14,38]],
    [["if",3,26],["add",14]],
    [["if",3,27],["add",17,38,38]],
    [["if",28],["add",18]],
    [["if",3,29],["add",19,22,46]],
    [["if",3,30],["add",21,37]],
    [["if",3,31],["add",26]],
    [["if",3,32],["add",30],["block",42,50,55]],
    [["if",3,33],["unless",34],["add",30]],
    [["if",35,36],["add",30]],
    [["if",3,39],["add",0]],
    [["if",41],["add",31]],
    [["if",41,42],["add",32]],
    ...
    [["if",3,44],["add",38]],
    [["if",3,45],["add",38]],
    [["if",3,46],["add",38],["block",42]],
    [["if",3,47],["add",38]],
    [["if",3,48],["add",38]],
    [["if",3],["unless",49],["add",38]],
    [["if",3,50],["add",38]],
    [["if",3,51],["add",38]],
    [["if",3,52],["add",38]],
    [["if",3,53],["add",38]],
    ...
    [["if",3,55],["unless",56,57],["add",38]],
    [["if",3,58],["add",38]],
    [["if",5,59],["add",39]],
    [["if",0,3],["unless",1,37],["add",42,54]],
    [["if",5,6,64],["add",43,44]],
    [["if",0,3,64],["add",45]],
    [["if",65,66,67,68],["add",47]],
    [["if",14,69],["add",52]],
    [["if",66,68,70],["add",55]],
    [["if",3,37],["block",30,0]],
    [["if",3,38],["block",30]],
    [["if",3,40],["block",0]],
    [["if",3,60],["block",42,50,55]],
    [["if",3,61],["block",42,50,55]],
    [["if",3,62],["block",42,50,55]],
    [["if",3,63],["block",42]]]
},
"runtime":[
[],[]
...
" - "+N+":"+R});D.apply(v.Za,arguments)};v.write(y,function(){e(A,C);v.Za.onerror=D;w.done();v=null;p()});return v}var q=0,r=[],v=null;return e(function(x,y,w){"function"===typeof w&&(w={done:w});w=g(w,k);x=/^#/.test(x)?l.document.getElementById(x.substr(1)):x.Kg?x[0]:x;var B=[x,y,w];x.Wf={cancel:function(){B.stream?B.stream.abort():B[1]=a}};w.Te(B);r.push(B);v||p();return x.Wf},{streams:{},Og:r,Eg:n})}();ec=l.postscribe}})();var rc={},sc=null,tc=Math.random();rc.m="GTM-7BF3X";rc.sb="430";var uc="www.googletagmanager.com/gtm.js";var vc=uc,wc=null,xc=null,yc=null,zc="//www.googletagmanager.com/a?id="+rc.m+"&cv=305",Ac={},Bc={},Cc=function(){var a=sc.sequence||0;sc.sequence=a+1;return a};var E=function(a,b,c,d){return(2===Dc()||d||"http:"!=f.location.protocol?a:b)+c},Dc=function(){var a=La(),b;if(1===a)a:{var c=vc;c=c.toLowerCase();for(var d="https://"+c,e="http://"+c,g=1,h=u.getElementsByTagName("script"),k=0;k<h.length&&100>k;k++){var l=h[k].src;if(l){l=l.toLowerCase();if(0===l.indexOf(e)){b=3;break a}1===g&&0===l.indexOf(d)&&(g=2)}}b=g}else b=a;return b};var Ec=!1;var Ic={},Jc=function(a){Ic.GTM=Ic.GTM||[];Ic.GTM[a]=!0};
